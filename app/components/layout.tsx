...
export const getSlotChild = (
    ...
    return children ? getChildByType(children, type) : null;
};

const NavBarSlot = Slot();

export const DefaultLayout = (props) => {
    const navBarSlot = getSlotChild(props.children, NavBarSlot);
    return (
        <div
            className={
                // "grid grid-rows-[1fr]" 
...
export const SideNavLayout = (props) => {
    return (
        <div className="flex bg-pink-100">
            <div className="flex h-screen min-h-[100vh] w-16 flex-col justify-between border-e bg-white">
                <div>
                    {/* <div className="inline-flex h-16 w-16 items-center justify-center">
                        <span
                            className="grid h-10 w-10 place-content-center rounded-lg bg-gray-100 text-xs text-gray-600 font-lobster"
                        >
                            L
                        </span>
                    </div> */}
